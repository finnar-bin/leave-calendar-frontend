...
const formatDate = date => moment(date).format("M/D/YYYY h:mm A");
...
class CalendarEvent extends Component {
  ...
  handleDelete = async (id, type) => {
    ...
    if (type === "Vacation Leave")
      toAdd = computeCredit(formatDate(event.start), formatDate(event.end));
      ...
      <Modal header="Leave Information">
        ...
        <div className="mb-4 text-center">
          <h5 className="card-title">
            <strong>
              {moment(event.start).format("MMM D h:mm A")} &mdash;{" "}
        ...
        <div className="mb-4 text-center">
          ...
          <h6 className="card-subtitle text-muted">
            ...
            this.state.showStatusForm === false ? (
              <a
                onClick={this.openStatusForm}
                style={{ cursor: "pointer" }}
                data-tip="Click to update leave status"
              >
